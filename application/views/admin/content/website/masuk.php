						...
						<div class="panel-body container-fluid table-detail">
									...
									<form action="" method="post" id="form">
										<div class='row margin-bottom'>
											...
											<div class='col-md-3 col-sm-12 select-search'>
												...
												<?php foreach ($this->ADM->grid_all_item('', 'id_item', 'DESC', $batas, $page, '' , '') as $item){ ?>
							...
							<?php } ?>
								...
								if ($jml_data > 0){
									...
									<b>Name: <?php echo $row2->nama_item;?></b> <br>
						...
						<div class="panel-body container-fluid">
							<form action="<?php echo site_url();?>website/masuk/tambah" method="post" id="exampleStandardForm" autocomplete="off">
								...
								<div class="form-group form-material">
									...
									<select name="id_item" class="form-control input-sm">
												<?php foreach ($this->ADM->grid_all_item('', 'id_item', 'DESC', 100, '', '' , '') as $item){ ?>
													<option value="<?php echo $item->id_item ?>"><?php echo $item->nama_item ?></option>
												<?php } ?>
												</select>
								</div>
